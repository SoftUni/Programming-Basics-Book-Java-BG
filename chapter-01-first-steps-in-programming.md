...
### Проектни решения и проекти във IntelliJ IDEA
...
Да се върнем на нашата конзолна програма. Вече имаме IntelliJ IDEA и можем да го стартираме. След това създаваме нов конзолен проект от [**Create New Project**]. Изберaме от диалоговия прозорец [Java] -> [Windows] -> [Comand Line App] и даваме подходящо име на проекта, например `HelloJava`:
