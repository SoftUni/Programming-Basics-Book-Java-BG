...
Първата част от прочитането е тривиална, като единственото нещо, на което трябва да обърнем внимание е използването на `BigDecimal` типа т.к. работим с пари и имаме нужда от голяма точност:
