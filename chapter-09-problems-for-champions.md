...
**_Внимание_**: Можем да преобразуваме цифрите до букви, използвайки това, че буквите са подредени в **ASCII таблицата**. Изразът **`'а' + i`** ще ни даде резултата '**a**', ако **`i`** е равно на 0, '**c**', ако **`i`** е равно на 2 и т.н.

Така имаме всички 5-буквени комбинации и можем да продължим със следващата част от задачата!

***Внимание*:** Тъй като сме подбрали **`pattern`** и циклите по подходящ начин, обикаляме думите в азбучен ред и няма нужда от допълнително сортиране преди извеждане.
