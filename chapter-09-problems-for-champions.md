...
***Внимание***: можем да преобразуваме цифрите до букви, използвайки това, че буквите са подредени в **ASCII таблицата**. Изразът **`'а' + i`** ще ни даде резултата '**a**', ако **`i`** е равно на 0, '**c**', ако **`i`** е равно на 2 и т.н.
