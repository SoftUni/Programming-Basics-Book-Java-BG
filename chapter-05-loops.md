...
![](assets/chapter-5-images/01_NewProject.png)
...
![](assets/chapter-5-images/02_NewProject.png)
...
![](assets/chapter-5-images/06_NewProject.png)
...
![](assets/chapter-5-images/07_NewProject.png)
...
![](assets/chapter-5-images/08_NewProject.png)

![](assets/chapter-5-images/09_NewProject.png)

След тези промени структурата на проекта ще изглежда по следния начин:
 
![](assets/chapter-5-images/10_NewProject.png)
...
| Вход | Изход | Вход | Изход |
| --- | --- | --- | --- |
| 6<br>2<br>3<br>5<br>4<br>2<br>1 | OddSum=9,<br>OddMin=2,<br>OddMax=5,<br>EvenSum=8,<br>EvenMin=1,<br>EvenMax=4 | 2<br>1.5<br>-2.5 | OddSum=1.5,<br>OddMin=1.5,<br>OddMax=1.5,<br>EvenSum=-0.5,<br>EvenMin=-2.5,<br>EvenMax=2 |
