...
За да решим задачата, трябва да декларираме символна променлива, в която ще пазим резултата. След това трябва да изпълним следните изчисления, нужни за конвертиране на числото.
