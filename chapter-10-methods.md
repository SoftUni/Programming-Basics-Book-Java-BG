...
* **Модификатор** В случая модификатора за достъп е **`public`**, което означава, че всички останали класове и методи могат да извикват нашия метод. Модификаторите в Java са много, но основните са : **`public`**(видим от всички), **`private`**(видими само от настоящия клас), **`protected`**.
