...
Програмният език Java е създаден от **Sun Microsystems** и те са тези, които създават една от първите конвенции за Java. Трябва да знаете също така, че дори да не спазвате общоприетите конвенциите, кодът ви ще работи (стига да е написан правилно), но просто няма да бъде лесно разбираем. Това, разбира се, не е фатално на основно ниво, но колкото по-бързо свикнете да пишете качествен код, толкова по-добре.
...
В случая използваме форматиращият стринг **`%.2f`**, което ще ограничи числовата променлива до 2 цифри след десетичния знак. Tрябва да имаме предвид, че числото пред буквата **`f`** означава до колко цифри след десетичния знак да е закръглено числото (т.е. може да е **``%.3f``** или **``%.5f``**).
