...
* **[Abbreviation]** - тук попълваме **code snippet**-a, който ще използваме. В конкретния случай това е **`scnl`**.
...
За да стартираме **програмата в режим на дебъгване**, избираме [**Run**] -> [**Debugg ...**] или натискаме [**SHIFT + F9**]:
