...
Програмният език Java е създаден от **Sun Microsystems** и те са тези, които създават една от първите конвенции за Java. Трябва да знаете също така, че дори да не спазвате общоприетите конвенциите, кодът ви ще работи (стига да е написан правилно), но просто няма да бъде лесно разбираем. Това, разбира се, не е фатално на основно ниво, но колкото по-бързо свикнете да пишете качествен код, толкова по-добре. (Съвременна Java конвенция е Google Java Style Guide: https://google.github.io/styleguide/javaguide.html)
