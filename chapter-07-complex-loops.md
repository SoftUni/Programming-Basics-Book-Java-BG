...
![](assets/chapter-7-images/Numbers1ToNWithStep3.png)
...
![](assets/chapter-7-images/NumbersFromNTo1.png)
...
![](assets/chapter-7-images/PowersOfTwo.png)
...
![](assets/chapter-7-images/EvenPowersOfTwo.png)
...
```java
while (...) {
	System.out.println("This is a while cycle");
}
```
...
![](assets/chapter-7-images/Sequence2KPlus1.png)
...
![](assets/chapter-7-images/NumberInRange1To100.png)
...
![](assets/chapter-7-images/GreatestCommonDivisor.png)
...
```java
do {
	System.out.println("This is a do-while cycle");
} while (...)
```
...
![](assets/chapter-7-images/Factorial.png)

#### Тестване в Judge системата

Тествайте решението си тук: [https://judge.softuni.bg/Contests/Practice/Index/659#7](https://judge.softuni.bg/Contests/Practice/Index/659#7) -- TODO - FIX BROKEN JUDGE - EXPECTS ZIP 
...
![](assets/chapter-7-images/SumOfDigits.png)
...
![](assets/chapter-7-images/PrimeNumbers.png)
...
![](assets/chapter-7-images/EnterEvenNumber.png)
...
![](assets/chapter-7-images/Fibonacci.png)
...
![](assets/chapter-7-images/NumberPyramid.png)
...
![](assets/chapter-7-images/NumberTable.png)
