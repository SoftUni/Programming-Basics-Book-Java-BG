...
<td><strong><code>\</code></strong> е специален символ в езика Java и използвайки само него в метода <strong><code>System.out.println(...)</code></strong>, конзолата няма да го разпечата, затова с <strong><code>\\</code></strong> показваме на конзолата, че искаме да отпечатаме точно този символ, без да се интерпретира като специален (**екранираме го**, на английски се нарича “**character escaping**”).</td>
</tr></table>
